    ...
    <div className="w-full flex items-center justify-center">
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6  fxl:gap-8">
        <div className="flex flex-col gap-6 justify-center">
          <h2 className="text-[32px] md:text-[45px] lg:text-[50px] xl:text-[45px] font-bold text-white w-[80%]">
            {title}
          </h2>
          <ul className="sm:text-xl md:text-[22px] lg:text-xl font-normal text-white gap-2 flex flex-col">
            {data.list.map((el, i) => {
              return (
