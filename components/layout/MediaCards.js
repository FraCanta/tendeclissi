      ...
      <div className="relative h-screen md:h-[70vh] lg:h-screen xl:h-[95vh] 2xla:h-[80vh] fxl:h-[90vh] w-full lg:w-[80%] xl:w-[70%] 2xl:w-[78%] fxl:w-[80%]">
        <div>
          ...
          <div className="absolute inset-0 flex flex-col items-center lg:justify-center gap-4 lg:text-center text-white mt-24 sm:my-32 md:mt-[70px] lg:mt-0 h-full">
            <h2 className="text-white text-[30px] md:text-[47px] lg:text-[45px] xl:text-[35px] 2xl:text-[45px] z-10 w-[90%] xl:w-[70%] 2xl:w-[65%] 2xla:w-[60%] mx-auto font-bold">
              {mainTitle}
            </h2>
            <p className="z-10 w-[90%] lg:w-[60%] fxl:w-[55%] mx-auto sm:text-xl md:text-[22px] lg:text-xl">
              {mainDescription}
            </p>
            <div className="lg:hidden absolute bottom-32 sm:bottom-40  md:bottom-36 md:left-10 xl:left-16 w-[90%] left-5 right-0  text-darkGray ">
              <Swiper
                slidesPerView={1}
                spaceBetween={20}
                pagination={{
