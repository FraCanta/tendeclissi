    ...
    >
      <div className="relative h-screen md:h-[80vh] lg:h-[60vh] xl:h-screen 2xl:h-[95vh] 2xla:h-[80vh] fxl:h-[90vh] w-full xl:w-[70%] 2xl:w-[78%] fxl:w-[80%]">
        <div>
          ...
          <div className="absolute inset-0 flex flex-col items-center xl:justify-center gap-4 lg:text-center text-white mt-12 sm:mt-32 md:mt-[90px] lg:mt-[150px] xl:mt-0 h-full">
            ...
            ></p>
            <div className="xl:hidden absolute bottom-24 sm:bottom-52   md:bottom-40 md:left-10 lg:bottom-52 xl:left-16 w-[90%] left-5 right-0  text-darkGray ">
              <Swiper
                slidesPerView={1}
                spaceBetween={20}
                pagination={{
